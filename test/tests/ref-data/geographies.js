...
describe('Geographies', function () {
  it('all', function (done) {
    askKodiak.getRefDataGeos({}, function (res) {
  ...
  it('united states', function (done) {
    askKodiak.getRefDataGeos({countries: 'us'}, function (res) {
  ...
  it('united states, states only', function (done) {
    askKodiak.getRefDataGeos({countries: 'us', subdivisionTypes: 'state'}, function (res) {
  ...
  it('canada', function (done) {
    askKodiak.getRefDataGeos({countries: 'ca'}, function (res) {
  ...
  it('canada, provinces', function (done) {
    askKodiak.getRefDataGeos({countries: 'ca', subdivisionTypes: 'province'}, function (res) {
