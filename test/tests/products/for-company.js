...
describe('Products For Company', function () {
  it('Returns expected object properties', function (done) {
    askKodiak.productsForCompany(gid, {}, function (res) {
      var ok = true,
          expected = [
            'gid',
            'name',
  ...
  it('Returns expected eligibility (include)', function (done) {
    askKodiak.productsForCompany(gid, {'includeEligibility': true}, function (res) {
  ...
  it('Returns expected filters (naics group)', function (done) {
    askKodiak.productsForCompany(gid, {'naicsGroups': '44-45'}, function (res) {
  ...
  it('Returns expected filters (naics groups)', function (done) {
    askKodiak.productsForCompany(gid, {'naicsGroups': '44-45+722515'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (naics code)', function (done) {
    askKodiak.productsForCompany(gid, {'naicsCodes': '9d709a5f8cefe02c3ba71bdd3a4c3e28'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (naics codes)', function (done) {
    askKodiak.productsForCompany(gid, {'naicsCodes': '9d709a5f8cefe02c3ba71bdd3a4c3e28+4797cab0bb586ec0a98da773878ef97d'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (owner)', function (done) {
    askKodiak.productsForCompany(gid, {'owners': 'ABC123'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (owners)', function (done) {
    askKodiak.productsForCompany(gid, {'owners': 'ABC123+DEF456'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (geo)', function (done) {
    askKodiak.productsForCompany(gid, {'geos': 'CA-ON'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (geos)', function (done) {
    askKodiak.productsForCompany(gid, {'geos': 'US-MA+CA-BC'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (geos with invalid val)', function (done) {
    askKodiak.productsForCompany(gid, {'geos': 'US-MA+CA-BC+TACO'}, function (res) {
      var filters = res.filters;
      assert.equal(filters.geos.length, 2);
      done();
    });
  ...
  it('Returns expected filters (coverage)', function (done) {
    askKodiak.productsForCompany(gid, {'productCodes': 'BOP'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (coverages)', function (done) {
    askKodiak.productsForCompany(gid, {'productCodes': 'BOP+WORK'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (entity type)', function (done) {
    askKodiak.productsForCompany(gid, {'entityTypes': 'AS'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (entity types)', function (done) {
    askKodiak.productsForCompany(gid, {'entityTypes': 'AS+CCORP'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (tag)', function (done) {
    askKodiak.productsForCompany(gid, {'tags': 'external-website'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (tags)', function (done) {
    askKodiak.productsForCompany(gid, {'tags': 'external-website+internal-portal'}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (annualPayroll)', function (done) {
    askKodiak.productsForCompany(gid, {'annualPayroll': 1000000}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (annualRevenue)', function (done) {
    askKodiak.productsForCompany(gid, {'annualRevenue': 5000000}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (fullTimeEmployees)', function (done) {
    askKodiak.productsForCompany(gid, {'fullTimeEmployees': 25}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (partTimeEmployees)', function (done) {
    askKodiak.productsForCompany(gid, {'partTimeEmployees': 10}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (yearsInBusiness)', function (done) {
    askKodiak.productsForCompany(gid, {'yearsInBusiness': 5}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected filters (yearsInIndustry)', function (done) {
    askKodiak.productsForCompany(gid, {'yearsInIndustry': 1}, function (res) {
      var filters = res.filters;
  ...
  it('Returns expected products per page (2)', function (done) {
    askKodiak.productsForCompany(gid, {'productsPerPage': 2}, function (res) {
  ...
  it('Returns expected page (p2)', function (done) {
    askKodiak.productsForCompany(gid, {'productsPerPage': 1, 'page': 2}, function (res) {
